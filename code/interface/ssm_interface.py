...
# Versão final da interface!
    ...
    # Cada ponto tem um botão de remove associado
    # Na view com os gráficos, já não há barra no topo, mas há um botão "Back", que volta ao mapa
                ...
                return (
                    html.Div([
                        ...
                        dcc.Graph(
                            ...
                            style={'height': '73vh'}  # Make the plot larger
                        ),
                        dbc.Button("Back", id='back-button', href='/', color="primary", className="mb-4")
                    ]),
                    None
                )
            except IndexError:
